            ...
            if (settings.start && _flipItems.length > 1) {
                ...
                if ( settings.start === 'center' ) {
                    if (!_flipItems.length % 2) {
						...
						$("ul.flip-items li.flip-current .flip-content img").attr("src", 'img/Sport'+_current+'.jpeg');
						if($("ul.flip-items li.flip-current")){
							$("ul.flip-items li.flip-current .flip-content img").attr("src", 'img/Sport'+_current+'.jpeg');
							$("ul.flip-items li.flip-prev .flip-content img").attr("src", 'img/sSport'+_current+'.jpeg');
							$("ul.flip-items li.flip-next .flip-content img").attr("src", 'img/sSport'+_current+'.jpeg');
						}
						else {
							$("ul.flip-items li.flip-current .flip-content img").attr("src", 'img/sSport'+_current+'.jpeg');
							$("ul.flip-items li.flip-prev .flip-content img").attr("src", 'img/sSport'+_current+'.jpeg');
							$("ul.flip-items li.flip-next .flip-content img").attr("src", 'img/sSport'+_current+'.jpeg');
						}
                    } else {
